...
/**
 * Loads and renders tasks into their respective quadrants
 * @async
 * @function loadMatrix
 * @description Retrieves tasks from Electron API, sorts them by deadline,
 * and dynamically generates task list items in the DOM
 * @throws {Error} If there's an issue retrieving or rendering tasks
 */
